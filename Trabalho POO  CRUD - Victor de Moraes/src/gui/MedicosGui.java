...
public class MedicosGui extends javax.swing.JFrame {
        ...
        if(txtIdMedicos.getText().isEmpty()){
            ...
            try {
              ...
              Class.forName("com.mysql.cj.jdbc.Driver");
               ...
               Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/hospital?useTimezone=true&serverTimezone=UTC","root","");
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        //Implementação do botão responsável por alterar os dados da base de dados
        Medicos medicos = new Medicos();
             medicos.setNome_medicos(txtNomeMedicos.getText());
             medicos.setCrm_medicos(txtCrmMedicos.getText());
             medicos.setEspecialidade_medicos(txtEspecialidadeMedicos.getText());
            ...
            if(txtNomeMedicos.getText().isEmpty() || txtCrmMedicos.getText().isEmpty() ||
            txtSalarioMedicos.getText().isEmpty()||txtEspecialidadeMedicos.getText().isEmpty())   
        {
        ...
        txtSalarioMedicos.setText(""); txtCrmMedicos.setText(""); 
        txtNomeMedicos.setText(""); txtEspecialidadeMedicos.setText("");
